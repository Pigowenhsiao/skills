...
The `data-integrity-guardian` skill covers reviews database migrations, data models, and persistent data code for safety.

Reviews database migrations, data models, and persistent data code for safety. Use it when checking migration safety, data constraints, transaction boundaries, or privacy compliance.
