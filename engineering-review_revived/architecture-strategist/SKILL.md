...
The `architecture-strategist` skill covers analyzes code changes from an architectural perspective for pattern compliance and design integrity.

Analyzes code changes from an architectural perspective for pattern compliance and design integrity. Use it when reviewing PRs, adding services, or evaluating structural refactors.
