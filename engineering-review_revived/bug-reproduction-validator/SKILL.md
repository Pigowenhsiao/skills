...
The `bug-reproduction-validator` skill covers systematically reproduces and validates bug reports to confirm whether reported behavior is an actual bug.

Systematically reproduces and validates bug reports to confirm whether reported behavior is an actual bug. Use it when you receive a bug report or issue that needs verification.
