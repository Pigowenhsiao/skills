...
The `schema-drift-detector` skill covers detects unrelated schema.rb changes in PRs by cross-referencing against included migrations.

Detects unrelated schema.rb changes in PRs by cross-referencing against included migrations. Use it when reviewing PRs with database schema changes.
