...
The `AutoIt v3` skill covers windows GUI 自動化腳本語言指南，專為 Windows GUI 自動化與通用腳本設計。涵蓋 XP 兼容性、核心指令集、環境建置與範例導向實踐。.

Windows GUI 自動化腳本語言指南，專為 Windows GUI 自動化與通用腳本設計。涵蓋 XP 兼容性、核心指令集、環境建置與範例導向實踐。
