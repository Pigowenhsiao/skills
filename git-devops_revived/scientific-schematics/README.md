...
# Directory: skills\git-devops\scientific-schematics
...
```bash
python scripts/generate_schematic.py \
  "MAPK signaling pathway: EGFR receptor â†’ RAS â†’ RAF â†’ MEK â†’ ERK â†’ nucleus. \
...
```bash
python scripts/generate_schematic.py \
  "IoT system block diagram: sensors (bottom) â†’ microcontroller â†’ \
   WiFi module and display (middle) â†’ cloud server â†’ mobile app (top). \
...
âœ“ "Flowchart with vertical flow, top to bottom"  
âœ“ "Architecture diagram with encoder on left, decoder on right"  
âœ— "Make a diagram" (too vague)

### Include Quantitative Details
âœ“ "Neural network: input (784), hidden (128), output (10)"  
âœ“ "Flowchart: n=500 screened, n=150 excluded, n=350 randomized"  
âœ— "Some numbers" (not specific)

### Specify Visual Style
âœ“ "Minimalist block diagram with clean lines"  
âœ“ "Detailed biological pathway with protein structures"  
âœ“ "Technical schematic with engineering notation"

### Request Specific Labels
âœ“ "Label all arrows with activation/inhibition"  
âœ“ "Include layer dimensions in each box"  
âœ“ "Show time progression with timestamps"

### Mention Color Requirements
âœ“ "Use colorblind-friendly colors"  
âœ“ "Grayscale-compatible design"  
âœ“ "Color-code by function: blue=input, green=processing, red=output"
...
- âœ“ **Fast**: Results in minutes
- âœ“ **Easy**: Natural language descriptions (no coding)
- âœ“ **Quality**: Automatic review and refinement
- âœ“ **Universal**: Works for all diagram types
- âœ“ **Publication-ready**: High-quality output immediately
