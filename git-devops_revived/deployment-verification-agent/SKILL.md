...
The `deployment-verification-agent` skill covers produces Go/No-Go deployment checklists with SQL verification queries, rollback procedures, and monitoring plans.

Produces Go/No-Go deployment checklists with SQL verification queries, rollback procedures, and monitoring plans. Use it when PRs touch production data, migrations, or risky data changes.
