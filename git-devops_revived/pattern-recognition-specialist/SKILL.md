...
The `pattern-recognition-specialist` skill covers analyzes code for design patterns, anti-patterns, naming conventions, and duplication.

Analyzes code for design patterns, anti-patterns, naming conventions, and duplication. Use it when checking codebase consistency or verifying new code follows established patterns.
