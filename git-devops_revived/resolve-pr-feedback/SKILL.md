...
The `resolve-pr-feedback` skill is for resolving PR review feedback by evaluating validity and fixing issues in parallel.

Resolve PR review feedback by evaluating validity and fixing issues in parallel. Use it when addressing PR review comments, resolving review threads, or fixing code review feedback.
