...
SOURCE_DIR = VAULT_DIR / "03-Resources" / "Weekly Reports Inbox"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--source-dir", type=Path, default=SOURCE_DIR, help="Directory containing weekly report files")
...
def main() -> int:
    ...
    if args.source_file:
        candidates = [candidate_from_file(args.source_file.expanduser().resolve())]
    else:
