...
This is the canonical `vault-bootstrap` Skill after Agent dedupe on 2026-04-29.

Archived duplicate variants:
- `Obsidian_skill_set/vault-bootstrap/SKILL.merged.md`
- `skills/vault-bootstrap/SKILL.merged.md`
<!-- /AGENT_SKILL_DEDUPE_NOTE -->
